    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                // 👇 ALLOW ADMIN TO VIEW USERS (Added /api/users/all)
                ...
                // Update User Status also needs to be allowed if Admin does it without token
                .requestMatchers("/api/users/status/**", "/api/users/**").permitAll() 
